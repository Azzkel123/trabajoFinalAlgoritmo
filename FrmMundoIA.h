...
namespace tb2Algoritmo{
	...
	public:
		FrmMundoIA(void)
		{
			...
			char rutaFondo[] = "fondo.png";
			service->cargarFondo(rutaFondo);

			char rutaMadre[] = "princesa.png";
			service->cargarSpriteMadre(rutaMadre, 4, 8);

			char rutaPersonaje[] = "personaje.png";
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->btnResetear->Location = System::Drawing::Point(1696, 694);
			   ...
			   this->lblVidas->Location = System::Drawing::Point(1693, 798);
			   ...
			   this->lblMonedas->Location = System::Drawing::Point(1409, 798);
			   this->lblMonedas->Name = L"lblMonedas";
			   this->lblMonedas->Padding = System::Windows::Forms::Padding(16, 12, 16, 12);
			   this->lblMonedas->Size = System::Drawing::Size(269, 70);
			   this->lblMonedas->TabIndex = 1;
			   this->lblMonedas->Text = L"Monedas: 0";
			   // 
			   // lblMensaje
			   // 
			   ...
			   this->lblMensaje->Padding = System::Windows::Forms::Padding(12, 12, 12, 12);
...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		lblMonedas->Text = "Monedas: " + service->getRecursosRecolectados();
		lblVidas->Text = "Vidas: " + service->getVidas();
